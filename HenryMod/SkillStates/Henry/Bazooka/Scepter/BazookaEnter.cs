...
namespace HenryMod.SkillStates.Bazooka.Scepter
{
    public class BazookaEnter : BaseHenrySkillState
    {
        ...
        public static SkillDef fireDef = Modules.Survivors.Henry.bazookaFireSkillDefScepter;
        public static SkillDef cancelDef = Modules.Survivors.Henry.bazookaCancelSkillDefScepter;
        ...
        public override void OnEnter()
        {
            ...
            base.PlayAnimation("Bazooka, Override", "BazookaAimScepter", "Bazooka.playbackRate", this.duration);
