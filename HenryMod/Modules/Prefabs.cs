...
namespace HenryMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        private static void SetupCameraTargetParams(GameObject prefab)
        {
            ...
            cameraTargetParams.cameraParams.data.idealLocalCameraPos = new Vector3(0f, 0f, -10f);
            ...
            //cameraTargetParams.data.aimMode = CameraTargetParams.AimType.Standard;
            cameraTargetParams.recoil = Vector2.zero;
            //cameraTargetParams.currentCameraParamsData.idealLocalCameraPos = Vector3.zero;
